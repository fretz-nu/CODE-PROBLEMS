...
public class GUI {
	...
	public static void main(String[] args) {
		...
		label1.setBounds(50, 130, 80, 20);
		label2.setBounds(50, 70, 80, 20);
		label3.setBounds(50, 30, 80, 20);
		r1.setBounds(120, 70, 120, 20);
		r2.setBounds(120, 90, 120, 20);
		cb.setBounds(120, 130, 90, 20);
		textfield1.setBounds(120, 30, 90, 30);
		label.setSize(400, 100);
		button.setBounds(120, 170, 90, 20);
